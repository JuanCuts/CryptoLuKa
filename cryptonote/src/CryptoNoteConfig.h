...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x63221af9e; // addresses start with "L"
...
const char     CRYPTONOTE_NAME[]                             = "perla";
...
const int      P2P_DEFAULT_PORT                              =  2121;
const int      RPC_DEFAULT_PORT                              =  2122;
